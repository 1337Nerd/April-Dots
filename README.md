...
To switch themes, use key combinations Ctrl + Shift + {M, S} for MacOS and Scott Pilgrim, respectively. This will change the <ul>Wallpaper</ul> <ul>System Colorscheme</ul> <ul>Polybar Colorscheme</ul> <ul>Terminal Colorscheme</ul> <ul>Firefox New Tab Page</ul>
